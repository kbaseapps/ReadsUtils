...
/**
 * <p>Original spec-file type: UploadStagingParams</p>
 * <pre>
...
@JsonPropertyOrder({
    "staging_fwd_file_name",
    "wsid",
    "wsname",
    "objid",
    "name",
    "staging_rev_file_name",
    "sequencing_tech",
    "single_genome",
    "strain",
    "source",
...
public class UploadStagingParams {

    @JsonProperty("staging_fwd_file_name")
    private String stagingFwdFileName;
    @JsonProperty("wsid")
    private Long wsid;
    @JsonProperty("wsname")
    ...
    @JsonProperty("name")
    private String name;
    @JsonProperty("staging_rev_file_name")
    private String stagingRevFileName;
    ...
    @JsonProperty("staging_fwd_file_name")
    public String getStagingFwdFileName() {
        return stagingFwdFileName;
    }

    @JsonProperty("staging_fwd_file_name")
    public void setStagingFwdFileName(String stagingFwdFileName) {
        this.stagingFwdFileName = stagingFwdFileName;
    }

    public UploadStagingParams withStagingFwdFileName(String stagingFwdFileName) {
        this.stagingFwdFileName = stagingFwdFileName;
        return this;
    }
    ...
    public UploadStagingParams withWsid(Long wsid) {
        this.wsid = wsid;
        return this;
    }
    ...
    public UploadStagingParams withWsname(String wsname) {
        this.wsname = wsname;
        return this;
    }
    ...
    public UploadStagingParams withObjid(Long objid) {
        this.objid = objid;
        return this;
    }
    ...
    public UploadStagingParams withName(String name) {
        this.name = name;
        return this;
    }

    @JsonProperty("staging_rev_file_name")
    public String getStagingRevFileName() {
        return stagingRevFileName;
    }

    @JsonProperty("staging_rev_file_name")
    public void setStagingRevFileName(String stagingRevFileName) {
        this.stagingRevFileName = stagingRevFileName;
    }

    public UploadStagingParams withStagingRevFileName(String stagingRevFileName) {
        this.stagingRevFileName = stagingRevFileName;
        return this;
    }
    ...
    public UploadStagingParams withSequencingTech(String sequencingTech) {
        this.sequencingTech = sequencingTech;
        return this;
    }
    ...
    public UploadStagingParams withSingleGenome(Long singleGenome) {
        this.singleGenome = singleGenome;
        return this;
    }
    ...
    public UploadStagingParams withStrain(StrainInfo strain) {
        this.strain = strain;
        return this;
    }
    ...
    public UploadStagingParams withSource(SourceInfo source) {
        this.source = source;
        return this;
    }
    ...
    public UploadStagingParams withInterleaved(Long interleaved) {
        this.interleaved = interleaved;
        return this;
    }
    ...
    public UploadStagingParams withReadOrientationOutward(Long readOrientationOutward) {
        this.readOrientationOutward = readOrientationOutward;
        return this;
    }
    ...
    public UploadStagingParams withInsertSizeMean(Double insertSizeMean) {
        this.insertSizeMean = insertSizeMean;
        return this;
    }
    ...
    public UploadStagingParams withInsertSizeStdDev(Double insertSizeStdDev) {
        this.insertSizeStdDev = insertSizeStdDev;
        return this;
    }
    ...
    public UploadStagingParams withSourceReadsRef(String sourceReadsRef) {
        this.sourceReadsRef = sourceReadsRef;
        return this;
    }
    ...
    public String toString() {
        return ((((((((((((((((((((((((((((((((("UploadStagingParams"+" [stagingFwdFileName=")+ stagingFwdFileName)+", wsid=")+ wsid)+", wsname=")+ wsname)+", objid=")+ objid)+", name=")+ name)+", stagingRevFileName=")+ stagingRevFileName)+", sequencingTech=")+ sequencingTech)+", singleGenome=")+ singleGenome)+", strain=")+ strain)+", source=")+ source)+", interleaved=")+ interleaved)+", readOrientationOutward=")+ readOrientationOutward)+", insertSizeMean=")+ insertSizeMean)+", insertSizeStdDev=")+ insertSizeStdDev)+", sourceReadsRef=")+ sourceReadsRef)+", additionalProperties=")+ additionalProperties)+"]");
    }
