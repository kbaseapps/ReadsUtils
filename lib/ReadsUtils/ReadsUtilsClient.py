...
class ReadsUtils(object):
    ...
    def upload_reads_from_staging_area(self, params, context=None):
        """
        ...
        """
        return self._client.call_method(
            'ReadsUtils.upload_reads_from_staging_area',
            [params], self._service_ver, context)

    def upload_reads_from_web(self, params, context=None):
        """
        ...
        """
        return self._client.call_method(
            'ReadsUtils.upload_reads_from_web',
            [params], self._service_ver, context)
